...
test('Full flow elements', async ({ page }) => {
  ...
  await expect(page.locator('form')).toContainText('Name your walletName your wallet to easily identify it while using the PANDAWALLETR. These names are stored locally, and can only be seen by you.');
