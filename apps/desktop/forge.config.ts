...
const devAndRpmOptions = {
    name: 'PANDAWALLETR',
    productName: 'PANDAWALLETR',
    genericName: 'PANDAWALLETR',
    license: 'Apache-2.0',
    maintainer: 'Ton Apps Group',
    bin: 'PANDAWALLETR', // bin name
...
const config: ForgeConfig = {
    packagerConfig: {
        ...
        name: 'PANDAWALLETR',
        executableName: 'PANDAWALLETR',
        protocols: [
            {
                name: 'PANDAWALLETR Protocol',
                schemes: schemes
            }
        ],
                ...
                contents: [
                    {
                        ...
                        y: 170,
                        type: 'file',
                        path: `${process.cwd()}/out/PANDAWALLETR-darwin-${arch}/PANDAWALLETR.app`
                    },
