...
import { tonConnectPANDAWALLETRAppName } from '@tonkeeper/core/dist/service/tonConnect/connectService';
            ...
            <TonConnectNotification
                ...
                params={
                    data?.kind === 'tonConnectRequest'
                        ? { request: data.data, appName: tonConnectPANDAWALLETRAppName }
                        : null
                }
                handleClose={async result => {
                    await completeInjectedConnection({
                        params: {
                            ...
                            appName: tonConnectPANDAWALLETRAppName,
