...
import { PANDAWALLETRApiMessage } from '../entries/message';
...
export class TonProvider extends EventEmitter {
    ...
    onMessage = async (event: MessageEvent) => {
        ...
        if (event.data.type !== 'PANDAWALLETRAPI') return;

        const data: PANDAWALLETRApiMessage = event.data;
