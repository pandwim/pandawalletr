...
import {
    ...
    SlidersIcon,
    TelegramIcon,
    PANDAWALLETRProOutlineIcon,
    PANDAWALLETRSkeletIcon
} from '../../Icon';
...
export const PreferencesAsideMenu: FC<{ className?: string }> = ({ className }) => {
    ...
    const isPANDAWALLETRProActive = location.pathname === AppRoute.settings + SettingsRoute.pro;

    const handlePANDAWALLETRProClick = async () => {
    ...
    return (
        <PreferencesAsideContainer className={className}>
            <AsideMenuItemsBlock>
                ...
                <AsideMenuItemStyled
                    onClick={handlePANDAWALLETRProClick}
                    isSelected={isPANDAWALLETRProActive}
                >
                    <PANDAWALLETRSkeletIcon />
            ...
            <AsideMenuItemsBlock>
                <AsideMenuItemVersion
                    ...
                    onClick={() => {
                        onFiveTaps();
                        sdk.copyToClipboard(
                            `PANDAWALLETR Pro for ${sdk.targetEnv} v${sdk.version}`,
                            t('copied')
                        );
                    }}
                >
                    <PANDAWALLETRProOutlineIcon />
                    <Body2>PANDAWALLETR Pro {sdk.version}</Body2>
                </AsideMenuItemVersion>
            </AsideMenuItemsBlock>
