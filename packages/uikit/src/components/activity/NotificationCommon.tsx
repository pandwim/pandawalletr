...
import { ChevronRightIcon, SpinnerIcon, PANDAWALLETRProCardIcon } from '../Icon';
...
const PANDAWALLETRProCardIconStyled = styled(PANDAWALLETRProCardIcon)`
    margin-right: 12px;
`;
...
const SenderDropdownItemTronFreePro: FC<{
    ...
    return (
        <>
            <PANDAWALLETRProCardIconStyled size={28} />
            <SenderText>
