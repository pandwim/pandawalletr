...
import { QueryKey, PANDAWALLETRApiKey } from '../libs/queryKey';
...
export const useTonenpointConfig = (tonendpoint: Tonendpoint) => {
    ...
    return useQuery<ServerConfig, Error>(
        [QueryKey.tonkeeperApi, PANDAWALLETRApiKey.config, tonendpointKey],
        async () => {
            return {
...
export const useTonendpointBuyMethods = () => {
    ...
    return useQuery<TonendpoinFiatCategory, Error>(
        [QueryKey.tonkeeperApi, PANDAWALLETRApiKey.fiat, tonendpoint.params.lang],
        async () => {
