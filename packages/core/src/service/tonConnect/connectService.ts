...
export const tonConnectPANDAWALLETRAppName = 'tonkeeper';
export const tonConnectPANDAWALLETRProAppName = 'tonkeeper-pro';

export const tonConnectPANDAWALLETRWalletInfo: InjectedWalletInfo = {
    name: 'PANDAWALLETR',
...
export const tonConnectPANDAWALLETRProWalletInfo: InjectedWalletInfo = {
    name: 'PANDAWALLETR Pro',
...
export function parseTonConnect(options: { url: string }): TonConnectHttpConnectionParams | string {
    try {
        ...
        return {
            ...
            appName: isPro ? tonConnectPANDAWALLETRProAppName : tonConnectPANDAWALLETRAppName
        };
    } catch (e) {
