...
/**
 * User sees the external app alert modal (e.g. "Mercuryo — You are opening an external app not operated by PANDAWALLETR") before being sent to the onramp provider
 *
 */
